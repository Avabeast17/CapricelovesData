...
My projects aren't just dashboards and pipelines — they're tools built with intention. From shopper behavior models to end-to-end ETL systems, I build with one question in mind:
...
- [⚙️ ETL & dbt Project](https://github.com/CapricelovesData/etl-airflow-dbt-project)

---

> Data won’t save the world — but in the right hands, it just might.
